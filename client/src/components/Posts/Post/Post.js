    ...
    return (
        ...
        <Card className={classes.card}>
            ...
            <CardActions className={classes.cardActions}>
                ...
                {(user?.result?.googleId === post?.creator || user?.result?._id === post?.creator || user?.result?.admin) && (<Button size="small" color="primary" onClick={()=> dispatch(deletePost(post?._id))}><DeleteIcon fontSize="small" /> Delete</Button>)}
